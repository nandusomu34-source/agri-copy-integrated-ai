  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'neon': '0 0 30px hsl(var(--neon-green) / 0.5)',
        'neon-lg': '0 0 50px hsl(var(--neon-green) / 0.6)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-neon": {
          "0%, 100%": { boxShadow: "0 0 10px hsl(var(--neon-green) / 0.4)" },
          "50%": { boxShadow: "0 0 35px hsl(var(--neon-green) / 0.7)" },
        },
        "shimmer": {
